...
public class UserService implements IUserRemote {
	...
	public void createUser(User user) {
		...
		try {
			...
			System.out.println("prob to send email" +user.getEmail());
			e.printStackTrace();
		}
	...
	public boolean changePwd(String oldPwd, String newPwd) {
		System.out.println("\n\n\n\n\n\n\n\n u : " + UserService.UserLogged.getId() + "\n\n\n\n\n\n\n\n\n");
		User user = entityManager.find(User.class, UserService.UserLogged.getId());
		Query query = entityManager
				.createQuery("SELECT new User(u.id,u.first_name,u.last_name,u.Ntelephone,u.email,u.password) "
